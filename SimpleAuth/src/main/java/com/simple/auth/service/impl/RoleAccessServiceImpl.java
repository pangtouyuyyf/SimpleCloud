...
import com.simple.auth.dao.RoleAccessDao;
import com.simple.auth.service.RoleAccessService;
...
public class RoleAccessServiceImpl implements RoleAccessService {
    ...
    public int saveRoleAccess(int currentUserId, JSONObject obj) {
        ...
        //查询现有角色请求
        List<Map<String, Integer>> savedList = Optional.of(this.roleAccessDao.queryAll(param)).orElseGet(() -> new ArrayList<>());
